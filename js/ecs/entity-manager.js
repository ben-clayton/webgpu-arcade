...
import { SystemStateComponent } from "./system-state-component.js";
...
export class EntityManager {
  ...
  entityAddComponent(entity, Component, values) {
    ...
    if (Component.isSingleton === true && !entity._isSingletonEntity === true) {
      throw new Error(
        `Attempted to add singleton component "${Component.getName()}"`
      );
    }
